<script >
 ...
 /* async function reloadProduct() {
    ...
    onMount(async ()=>{
      const res =await fetch(`https://api.wynwoodstore.net/notificationsmercadolibres`)
  ...
  <h1>Notificaciones   <button class="btn btn-primary " style="margin:auto"> Actualizar</button>
  </h1>
